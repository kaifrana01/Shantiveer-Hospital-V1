# Generated by Django 4.2.23 on 2026-06-20 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investigation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='lab.ultrasoundinvestigation')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab.ultrasoundtestmaster')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investigation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='lab.ultrasoundinvestigation')),
            ],
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical ultrasound test master',
                'verbose_name_plural': 'historical ultrasound test masters',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('investigation', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='lab.ultrasoundinvestigation')),
                ('test', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='lab.ultrasoundtestmaster')),
            ],
            options={
